class CreditCardsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @credit_card.update(credit_card_params)
        format.html { redirect_to @credit_card, notice: "Credit card was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to credit_cards_path, notice: "Credit card was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def credit_card_params
      params.expect(credit_card: [ :name, :card_number, :expiration_date, :cvv ])
    end
end
